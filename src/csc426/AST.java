...
public abstract class AST {
    ...
    public static final class ConstDecl
    extends AST {
        ...
        public String toString() {
            return "Constant declaration " + this.id + " at " + this.position;
        }
    }
    ...
    extends AST {
        ...
        extends Expr {
            ...
            public String toString() {
                return "Binary operation " + (Object)this.op + " at " + this.position;
            }
        }
        ...
        extends Expr {
            ...
            public String toString() {
                return "Boolean literal false at " + this.position;
            }
        }
        ...
        extends Expr {
            ...
            public String toString() {
                return "Variable " + this.id + " at " + this.position;
            }
        }
        ...
        extends Expr {
            ...
            public String toString() {
                return "Integer literal " + this.value + " at " + this.position;
            }
        }
        ...
        extends Expr {
            ...
            public String toString() {
                return "Boolean literal true at " + this.position;
            }
        }
        ...
        extends Expr {
            ...
            public String toString() {
                return "Unary operation " + (Object)this.op + " at " + this.position;
            }
        }
    ...
    extends AST {
        ...
        public static final class ExprItem
        extends Item {
            public final Expr expr;
            ...
            public String toString() {
                return "Print expression item at " + this.position;
            }
        }
        ...
        extends Item {
            ...
            public String toString() {
                return "Print string item at " + this.position;
            }
        }
    ...
    extends AST {
        ...
        extends Param {
            ...
            public String toString() {
                return "Value parameter " + this.id + " at " + this.position;
            }
        }
        ...
        extends Param {
            ...
            public String toString() {
                return "Variable parameter " + this.id + " at " + this.position;
            }
        }

    }

    public static final class ProcDecl
    extends AST {
        public final String id;
        ...
        public String toString() {
            return "Procedure declaration " + this.id + " at " + this.position;
        }
    }
    ...
    extends AST {
        ...
        public String toString() {
            return "Program " + this.name + " at " + this.position;
        }
    }
    ...
    extends AST {
        ...
        extends Stmt {
            ...
            public String toString() {
                return "Assignment to " + this.id + " at " + this.position;
            }
        }
        ...
        extends Stmt {
            ...
            public String toString() {
                return "Call to " + this.id + " at " + this.position;
            }
        }
        ...
        extends Stmt {
            ...
            public String toString() {
                return "If-then statement at " + this.position;
            }
        }

        public static final class IfThenElse
        extends Stmt {
            public final Expr test;
            public final Stmt trueClause;
            ...
            public String toString() {
                return "If-then-else statement at " + this.position;
            }
        }
        ...
        extends Stmt {
            ...
            public String toString() {
                return "Print statement at " + this.position;
            }
        }
        ...
        extends Stmt {
            ...
            public String toString() {
                return "Prompt statement at " + this.position;
            }
        }

        public static final class Prompt2
        extends Stmt {
            public final String message;
            public final String id;
            ...
            public String toString() {
                return "Prompt of " + this.id + " at " + this.position;
            }
        }
        ...
        extends Stmt {
            ...
            public String toString() {
                return "Sequence at " + this.position;
            }
        }
        ...
        extends Stmt {
            ...
            public String toString() {
                return "While statement at " + this.position;
            }
        }
    ...
    public static final class VarDecl
    extends AST {
        public final String id;
        public final Type type;
        ...
        public String toString() {
            return "Variable declaration " + this.id + " at " + this.position;
        }
    }
